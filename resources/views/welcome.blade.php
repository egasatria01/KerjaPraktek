    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-12 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg" style="margin-top: 50px">
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-6">
                            <form action="/" method="GET">
                                ...
                                <div class="search d-flex">
                                    <div class="d-blox justify-content-center m-1">
                                        <label for="nama" class="statistics-title mt-1">Cari : </label>
                                    </div>
                                    <div class="d-blox justify-content-center m-1">
                            ...
                            <table id="table-data" class="table table-bordered text-center" style="margin-top: 20px">
                                <thead>
